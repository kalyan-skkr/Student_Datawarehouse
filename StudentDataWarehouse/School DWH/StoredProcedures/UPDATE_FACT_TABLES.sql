...
BEGIN
	...
	SET @EXISTING_GPA = (SELECT OVERALLCGPA FROM FACTGRADEPOINT WHERE STUDENTID = @STDID AND GPAUPDATED = 0)
	...
	BEGIN
		...
		INSERT INTO FACTGRADEPOINT(STUDENTID, OVERALLCGPA, GPAUPDATED) VALUES
		(@STDID, @NEW_GPA, 0)
	END
